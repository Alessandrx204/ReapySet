...
from PySide6.QtCore import QRect, QEasingCurve, QPropertyAnimation, QTimer
...
def resizewindow():
    ...
    ...
#TODO https://claude.ai/chat/9356ef75-af63-406d-ab80-f0a971874d7e
...
class LogicMainWindow(RsMainWindow):
    ...
    def expand_window(self):
        ...
        self.anim.start()
        QTimer.singleShot(45, lambda: self.widget3_stacked.setEnabled(True))
    ...
    def collapse_window(self):
        self.anim = QPropertyAnimation(self, b"geometry")
        QTimer.singleShot(45, lambda: self.widget3_stacked.setEnabled(False))
        ...
        #time.sleep(2)
        # ✅ Non-blocking delay
        QTimer.singleShot(450, lambda: self.setFixedSize(700, 300))
